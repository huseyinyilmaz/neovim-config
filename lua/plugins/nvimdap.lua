local setup_dap_python = function(dap)
  local host = "127.0.0.1"
	local port_python = 5678
	...
	dap.configurations.python = {
		{
			name = "Attach to 127.0.0.1:5678", -- configuration for attaching to a running process
			type = "debugpy",
			request = "attach",
			mode = "remote",
		},
...
local setup_dap_go = function(dap)
  local host = "127.0.0.1"
  local port_go = 38697
